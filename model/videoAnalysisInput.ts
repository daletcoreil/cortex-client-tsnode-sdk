...
*/
export class VideoAnalysisInput extends JobInput {
    'inputFile': Locator;
    'outputLocation': Locator;
    /**
    * Determine which types of AI analyses are to be indexed.
    */
    'dataFilter'?: Array<VideoAnalysisInput.DataFilterEnum>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "dataFilter",
            "baseName": "dataFilter",
            "type": "Array<VideoAnalysisInput.DataFilterEnum>"
        },
        {
            "name": "language",
            "baseName": "language",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VideoAnalysisInput.attributeTypeMap);
    }
}

export namespace VideoAnalysisInput {
    export enum DataFilterEnum {
        AudioEffects = <any> 'audioEffects',
        Brands = <any> 'brands',
        Faces = <any> 'faces',
        Keywords = <any> 'keywords',
        Labels = <any> 'labels',
        Ocr = <any> 'ocr',
        Sentiments = <any> 'sentiments',
        Shots = <any> 'shots',
        TextualContentModeration = <any> 'textualContentModeration',
        Transcript = <any> 'transcript',
        VisualContentModeration = <any> 'visualContentModeration'
    }
}
