...
*/
export class JobMediatorStatus {
    /**
    ...
    */
    'status': JobMediatorStatus.StatusEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "JobMediatorStatus.StatusEnum"
        },
        {
            "name": "statusMessage",
    ...
    static getAttributeTypeMap() {
        return JobMediatorStatus.attributeTypeMap;
    }
}

export namespace JobMediatorStatus {
