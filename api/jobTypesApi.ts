...
export class JobTypesApi {
     ...
     */
    public async getAllJobTypes (projectServiceId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<JobType>;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Array<JobType>;  }>((resolve, reject) => {
