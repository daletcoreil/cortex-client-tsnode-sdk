...
export class JobsApi {
     ...
     */
    public async createJob (jobMediatorInput: JobMediatorInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: MediatorJob;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: MediatorJob;  }>((resolve, reject) => {
     ...
     */
    public async getJobById (jobId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: MediatorJob;  }> {
